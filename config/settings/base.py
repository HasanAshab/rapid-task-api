...
# ranker.challenges
CHALLENGE_SUGGESTION_LOOKBACK_LIMIT = 50
COMPLETED_CHALLENGE_SCORE_PENALTY = 100
REPEATED_CHALLENGE_SCORE_PENALTY = 50

# ranker.difficulty
MAX_DIFFICULTY_SCORE = 1000
DIFFICULTY_SUGGESTION_LOOKBACK_LIMIT = 50
DIFFICULTY_SUGGESTION_THRESHOLD = 0.5
